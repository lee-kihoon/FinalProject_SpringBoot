    ...
    // 오늘의 chart
    var totalSquat = document.getElementById('totalsquat').value;
    var totalPlank = document.getElementById('totalplank').value;
    var totalLunge = document.getElementById('totallunge').value;
    var totalPushup = document.getElementById('totalpushup').value;
    var totalSitup = document.getElementById('totalsitup').value;
(function($) {
  'use strict';
  $(function() {
    if ($("#order-chart").length) {
      var areaData = {
        labels: ["스쿼트", "플랭크", "푸쉬업", "런지", "싯업"],
        datasets: [
          {
            data: [totalSquat, totalPlank, totalPushup, totalLunge, totalSitup],
            borderColor: [
              '#4747A1'
            ],
            borderWidth: 2,
    ...
    if ($("#sales-chart").length) {
      ...
      var SalesChart = new Chart(SalesChartCanvas, {
        ...
        data: {
          ...
          datasets: [{
              label: '오늘의 운동량',
              data: [squat, plank, pushup, lunge, situp],
...
var dateSquat = document.getElementById('dateSquat').value;
var datePlank = document.getElementById('datePlank').value;
var dateLunge = document.getElementById('dateLunge').value;
var datePushup = document.getElementById('datePushup').value;
var dateSitup = document.getElementById('dateSitup').value;
...
if ($("#sales-chart2").length) {
  ...
  var SalesChart = new Chart(SalesChartCanvas, {
    ...
    data: {
      ...
      datasets: [{
          label: textDate,
          data: [dateSquat, datePlank, datePushup, dateLunge, dateSitup],
          backgroundColor: '#c76eff'
        }
        /*{
          label: 'Online Sales',
          data: [400, 340, 550, 480, 170],
  ...
  document.getElementById('sales-legend2').innerHTML = SalesChart.generateLegend();
}
